...
def main():
    ...
    #
    # sm = ScoreModel(d_in=X.shape[1], d_phi=512, hidden=(512, 512), dropout=0.2, device="cuda")
    # sm.pretrain(X, Y, lr=1e-3, weight_decay=5e-4, loss="huber", val_frac=0.2)
    sm.save("sft_eval_scores/llm_mlp.pt")
