...
if __name__ == "__main__":
    ...
    # adapter_model = "./sft-grpo-500-for-comp"
    adapter_model = "./grpo-out-500"
    base_model = AutoModelForCausalLM.from_pretrained("meta-llama/Llama-3.2-3B-Instruct", dtype="auto", device_map="auto")
    ...
    paths = evaluate_llm_vs_oracle(
        sampler=sampler,
        num_trials=100,
        # out_dir="grpo_sft_cal_scores_500",
        out_dir="grpo_cal_scores_500",
