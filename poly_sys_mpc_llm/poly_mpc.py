...
# cfg = PolyThetaConfig(n=3, m=2, d_f=2, d_G=2, dt=0.1, N=25, r=2.0)
...
#
# feat_score, prompt_score = build_beta_prompt_simple(b_m, b_t, b_u, b_du)
# print(prompt_score)
...
if __name__ == "__main__":
    ...
    # Print the result
    print(f"The program executed in {elapsed_time:.4f} seconds.")

    # cfg_ilqr = ILQRMPCConfig(
    #     H=5,  # reuse your base horizon
    #     max_iters=10,  # reuse your base iterations
    #     u_min=-u_max,
    #     u_max=u_max,
    #     shift_fill="zero",
    # )
    #
    # def mpc_builder(inst, cost_obj, cfg_ilqr):
    #     # inst MUST provide these (recommended to add in your generator return dict):
    #     # inst["cfg"], inst["exps"], inst["drift"], inst["inp"]
    #
    #     dyn = PolyDynamicsWithJac(
    #         cfg=inst["cfg"],
    #         drift=inst["drift"],
    ...
    #     )
    #
    #     return FastILQRMPC(dyn=dyn, cost=cost_obj, cfg=cfg_ilqr)
    #
    #
    # best = run_weight_search_for_instance_fast_ilqr(
    #     inst=inst,
    #     scorer=scorer,
    #     run_closed_loop_fast_ilqr_mpc=run_closed_loop_fast_ilqr_mpc,
    #     mpc_builder=mpc_builder,                 # you define this (below)
    #     ilqr_cfg_base=cfg_ilqr,                  # your ILQRMPCConfig / base config
    #     QuadCostConfig=QuadCostConfig,
    #     FastQuadraticCost=FastQuadraticCost,
    #     K=64,
    #     T_outer=15,
